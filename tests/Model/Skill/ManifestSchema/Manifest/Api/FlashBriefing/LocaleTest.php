...
namespace Omissis\AlexaSdk\Tests\Model\Skill\ManifestSchema\Manifest\Api\FlashBriefing;
...
final class LocaleTest extends TestCase
{
    public function test_it_exposes_accessors(): void
    {
        ...
        $this->assertSame('Some error', $locale->getCustomErrorMessage());
        $this->assertSame([$feed], $locale->getFeeds());
    }
}
